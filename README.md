...
- Optional [Auto Scroll](docs/features.md#auto-scroll-and-automatic-pagination) per tab, with adjustable speed, Pause/Resume, optional pause after a highlighted positive keyword, infinite scrolling and supported automatic pagination. Tab sessions reset on browser restart.
