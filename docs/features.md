...
- `src/navigation/state.js` contains the pure state transitions. Records contain enabled, paused, speed, revision, documentId, URL, pending target/expiry, visited targets/content signatures, and status reason. No Y coordinate is persisted.
